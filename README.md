...
This project predicts NFL game outcomes using historical game data, betting spreads, and team performance metrics.
...
### 📊 Model Accuracy
**~69% accuracy** predicting whether the home team wins.
...
- Applying machine learning to real-world sports problems
